...
<tr><td>Yangın Kontrol Saati:</td><td><input type="time" name="yangin_kontrol_saati"></td></tr><br><br>&nbsp;
...
<tr><td>Yangın Sahibi:</td><td><input type="text" name="yangin_sahibi"></td></tr><br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br>
...
<tr><td>Emniyet-Jandarma Geliş Saati:</td><td><input type="time" name="emniyet_gelis"></td></tr><br><br>
...
<tr><td>İtfaiye Eri:</td><td><input type="text" name="itfaiye_er"></td></tr>&nbsp; &nbsp; &nbsp; &nbsp;
<tr><td>İtfaiye Birim Amiri:</td><td><input type="text" name="itfaiye_birim_amir"></td></tr><br><br>
<tr><td>İtfaiye Birim Amiri:</td><td><input type="text" name="itfaiye_birim_amir"></td></tr>&nbsp; &nbsp; &nbsp; &nbsp;
...
<label>Ana Ekip İD:</label>
<select name="ana_ekip_id" id="ana_ekip_id">
	<option value="0" selected>Ana Ekip ID Seçiniz</option>
	<?php
		$sql= mysqli_query($baglan,"select * from ana_ekip_id");
		while($tumu = mysqli_fetch_array($sql)){
			echo '<option value="'.$tumu["ana_ekip_id"].'">'.$tumu["amir"].'</option>';
		}
	?>
</select>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
...
<tr><td>Personel sayısı:</td><td><input type="number" name="personel_sayisi"></td></tr><br><br>
<tr><td>Çıkış saati:</td><td><input type="time" name="cikis_saati"></td></tr>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<tr><td>Dönüş Tarihi:</td><td><input type="date" name="ekip_donus_tarihi"></td></tr>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br><br><br>


<label>Yardımcı Ekip ID</label>
<select name="yardimci_ekip_id" id="yardimci_ekip_id">
	<option value="0" selected>Yardımcı Ekip ID Seçiniz</option>
	<?php
		$sql= mysqli_query($baglan,"select * from yardimci_ekip_id");
		while($tumu = mysqli_fetch_array($sql)){
			echo '<option value="'.$tumu["yardimci_ekip_id"].'">'.$tumu["yard_amir"].'</option>';
		}
	?>
</select>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<tr><td>Personel sayısı:</td><td><input type="number" name="yard_personel_sayisi"></td></tr><br><br>
<tr><td>Çıkış saati:</td><td><input type="time" name="yard_cikis_saati"></td></tr>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
