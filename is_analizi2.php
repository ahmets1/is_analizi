...
if(isset($gonder)){
		...
		$sql1="INSERT INTO `ana_ekip` (`kayit_no`, `amir`, `cikis_saati`, `varis_saati`, `personel_sayisi`, `ekip_donus_tarihi`, `ekip_donus_saati`, `ana_ekip_id`) VALUES ('$kayit_no', '$amir', '$cikis_saati', '$varis_saati', '$personel_sayisi', '$ekip_donus_tarihi', '$ekip_donus_saati', '$ana_ekip_id')";
		
		$sql2="INSERT INTO `ana_ekip_arac` (`ana_arac_sayisi`, `ana_plaka_no`, `ana_ekip_id`) VALUES ('$ana_arac_sayisi', '$ana_plaka_no', '$ana_ekip_id')";
		
		$sql3="INSERT INTO `yardimci_ekip` (`kayit_no`, `yardimci_ekip_id`, `yard_amir`, `yard_cikis_saati`, `yard_varis_saati`, `yard_personel_sayisi`, `yard_ekip_donus_tarihi`, `yard_ekip_donus_saati`) VALUES ('$kayit_no', '$yardimci_ekip_id', '$yard_amir', '$yard_cikis_saati', '$yard_varis_saati', '$yard_personel_sayisi', '$yard_ekip_donus_tarihi', '$yard_ekip_donus_saati')";
